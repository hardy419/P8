...
class Page {
    ...
    public function show($class="") {
        ...
        if ($upRow>0){
            ...
            $upPage="<li class='disabled'><a href='".$url."&".$p."=$upRow'>".$this->config['prev']."</a></li>";
        }

        if ($downRow <= $this->totalPages){
            $downPage="<li><a href='".$url."&".$p."=$downRow'>".$this->config['next']."</a></li>";
        }else{
            $downPage="<li class='disabled'><a href='".$url."&".$p."=$downRow'>".$this->config['next']."</a></li>";
        }
        // << < > >>
        if($nowCoolPage == 1){
            $theFirst = "";
            ...
            $prePage = "<li><a href='".$url."&".$p."=$preRow' >Up ".$this->rollPage." Page</a></li>";
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            $nextPage = "<li><a href='".$url."&".$p."=$nextRow' >Next ".$this->rollPage." Page</a></li>";
